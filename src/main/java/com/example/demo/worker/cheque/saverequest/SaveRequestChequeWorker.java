package com.example.demo.worker.cheque.saverequest;
...
@Component
public class SaveRequestChequeWorker {

    private static final String TOPIC_NAME = "SaveRequestChequeWorker";
    ...
    private final SaveRequestChequeService apiService;

    public SaveRequestChequeWorker(ApiUrlsProperties properties, SaveRequestChequeService apiService) {
    ...
    public void subscribe() {
        ...
        client.subscribe(TOPIC_NAME)
                ...
                .handler((externalTask, externalTaskService) -> {
                    ...
                    String countPage = externalTask.getVariable("countPage");
                    String chequeType = externalTask.getVariable("chequeType");
                    String branchCode = externalTask.getVariable("branchCode");
                    String postalCode = externalTask.getVariable("postalCode");
                    String postalAddress = externalTask.getVariable("postalAddress");
                    String selectedDeposit = externalTask.getVariable("selectedDeposit");
                    String deliveryType = externalTask.getVariable("deliveryType");

                    try {
                        Map<String, Object> responseMap = apiService.callUserApi(nationalCode, mobile, fullName, applicationKey, customerNumber, countPage, chequeType,
