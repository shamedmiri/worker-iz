...
import com.example.demo.service.loan.SaveStatusHistoryService;
...
@Component
public class SaveStatusHistoryWorker {

    private static final String TOPIC_NAME = "SaveStatusHistoryWorker";
    ...
    private final SaveStatusHistoryService apiService;

    public SaveStatusHistoryWorker(ApiUrlsProperties properties, SaveStatusHistoryService apiService) {
    ...
    public void subscribe() {
        ...
        client.subscribe(TOPIC_NAME)
                ...
                .handler((externalTask, externalTaskService) -> {
                    ...
                    try {
                        Map<String, Object> responseMap = apiService.callUserApi(RequestId, StatusDescription,StatusCode );
