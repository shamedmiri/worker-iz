...
@Component
public class GetRequestLoanWorker {

    private static final String TOPIC_NAME = "GetRequestLoanWorker";
    ...
    private final GetRequestLoanService apiService;

    public GetRequestLoanWorker(ApiUrlsProperties properties, GetRequestLoanService apiService) {
    ...
    public void subscribe() {
        ...
        client.subscribe(TOPIC_NAME)
                ...
                .handler((externalTask, externalTaskService) -> {
                    ...
                    try {
                        Map<String, Object> responseMap = apiService.callUserApi(NationalCode,RequestId);
