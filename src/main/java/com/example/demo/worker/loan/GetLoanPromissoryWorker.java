...
@Component
public class GetLoanPromissoryWorker {
    ...
    private final GetLoanPromissoryService apiService;

    public GetLoanPromissoryWorker(ApiUrlsProperties properties, GetLoanPromissoryService apiService) {
    ...
    public void subscribe() {
        ...
        client.subscribe(TOPIC_NAME)
                ...
                .handler((externalTask, externalTaskService) -> {
                    ...
                    String RequestId = externalTask.getVariable("");
