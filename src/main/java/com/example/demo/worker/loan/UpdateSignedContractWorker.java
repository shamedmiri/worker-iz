...
import com.example.demo.service.loan.UpdateSignedContractService;
...
@Component
public class UpdateSignedContractWorker {

    private static final String TOPIC_NAME = "UpdateSignedContractWorker";
    ...
    private final UpdateSignedContractService apiService;

    public UpdateSignedContractWorker(ApiUrlsProperties properties, UpdateSignedContractService apiService) {
    ...
    public void subscribe() {
        ...
        client.subscribe(TOPIC_NAME)
                ...
                .handler((externalTask, externalTaskService) -> {
                    String SignedContract = externalTask.getVariable("PathSingedPDF");
                    String RequestId = externalTask.getVariable("RequestIdLoan");

                    try {
                        Map<String, Object> responseMap = apiService.callUserApi(SignedContract, RequestId);
