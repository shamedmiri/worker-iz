...
@Component
public class SaveRequestGuarantorsWorker {

    private static final String TOPIC_NAME = "SaveRequestGuarantorsWorker";
    ...
    private final SaveRequestGuarantorsService apiService;

    public SaveRequestGuarantorsWorker(ApiUrlsProperties properties, SaveRequestGuarantorsService apiService) {
    ...
    public void subscribe() {
        ...
        client.subscribe(TOPIC_NAME)
                ...
                .handler((externalTask, externalTaskService) -> {
                    String RequestGuarantors = externalTask.getVariable("");

                    try {
                        Map<String, Object> responseMap = apiService.callUserApi(RequestGuarantors);
