...
@Component
public class RequestGetPlanDocumentsWorker {

    private static final String TOPIC_NAME = "RequestGetPlanDocumentsWorker";
    ...
    public RequestGetPlanDocumentsWorker(ApiUrlsProperties properties, RequestGetPlanDocumentsService apiService) {
    ...
    public void subscribe() {
        ...
        client.subscribe(TOPIC_NAME)
                ...
                .handler((externalTask, externalTaskService) -> {
                    String planId = externalTask.getVariable("");
