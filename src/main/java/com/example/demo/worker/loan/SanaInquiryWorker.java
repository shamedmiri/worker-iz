...
@Component
public class SanaInquiryWorker {

    private static final String TOPIC_NAME = "SanaInquiryWorker";
    ...
    private final SanaInquiryService apiService;

    public SanaInquiryWorker(ApiUrlsProperties properties, SanaInquiryService apiService) {
    ...
    public void subscribe() {
        ...
        client.subscribe(TOPIC_NAME)
                ...
                .handler((externalTask, externalTaskService) -> {
                    ...
                    String PersonType = externalTask.getVariable("");

                    try {
                        Map<String, Object> responseMap = apiService.callUserApi(NationalCode,PersonType);
