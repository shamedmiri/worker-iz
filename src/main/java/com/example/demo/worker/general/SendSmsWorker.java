...
public class SendSmsWorker {
    ...
    private static final String TOPIC_NAME = "sendSmsWorker";
    ...
    private final SendSmsService apiService;

    public SendSmsWorker(ApiUrlsProperties properties, SendSmsService apiService) {
    ...
    public void subscribe() {
        ...
        client.subscribe(TOPIC_NAME)
                ...
                .handler((externalTask, externalTaskService) -> {
                    ...
                    try {
                        Map<String, Object> responseMap = apiService.callUserApi(mobiles, message);
