...
import com.example.demo.service.card.OtherBanksIbanInfoService;
...
@Component
public class OtherBanksIbanInfoWorker {
    private static final String TOPIC_NAME = "OtherBanksIbanInfoWorker";
    ...
    private final OtherBanksIbanInfoService apiService;

    public OtherBanksIbanInfoWorker(ApiUrlsProperties properties, OtherBanksIbanInfoService apiService) {
