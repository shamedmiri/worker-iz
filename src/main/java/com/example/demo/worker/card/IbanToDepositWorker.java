...
import com.example.demo.service.card.IbanToDepositService;
...
@Component
public class IbanToDepositWorker {
    private static final String TOPIC_NAME = "IbanToDepositWorker";
    ...
    private final IbanToDepositService apiService;

    public IbanToDepositWorker(ApiUrlsProperties properties, IbanToDepositService apiService) {
